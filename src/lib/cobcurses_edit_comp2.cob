        ...
        PROGRAM-ID. COBCURSES-EDIT-COMP-2.
        ...
        PROCEDURE DIVISION
          USING
            ...
            OR LS-OUT-COMP-2-ITEM OMITTED THEN
        ...
        9000-FINALIZE.
            IF RETURN-CODE = NC-RET-OK THEN
                MOVE WS-OUT-COMP-2-ITEM TO LS-OUT-COMP-2-ITEM
            ELSE
                MOVE ZERO TO LS-OUT-COMP-2-ITEM
            END-IF.
            EXIT.

        END PROGRAM COBCURSES-EDIT-COMP-2.
