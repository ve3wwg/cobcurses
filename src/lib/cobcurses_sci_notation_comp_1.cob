        ...
        PROGRAM-ID. COBCURSES-SCI-NOTATION-COMP-1.
      *>
      *> CONVERT A COMP-1 ITEM INTO DISPLAYABLE EXPONENTIAL FORMAT :
      *>
      *> INPUTS: 
      ...
      *>
        ...
        PROCEDURE DIVISION
            USING LS-COMP-1, LS-BUFFER, LS-BUFLEN,
        ...
        5000-PROCESS.
            CALL "NC_SCINOTATION_COMP1" USING
                WS-COMP-1, WS-BUFFER-PTR, WS-BUFLEN,
        ...
        END PROGRAM COBCURSES-SCI-NOTATION-COMP-1.
