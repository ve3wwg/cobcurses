        ...
        PROGRAM-ID. COBCURSES-ECVT-COMP-2.
      *>
      *> CONVERT A COMP-2 ITEM INTO DISPLAYABLE TEXT :
      *>
      ...
      *> FOR EXAMPLE:
      *>
      *>     RETURNED BUFFER RESULTS ARE '+230000000000'
      ...
      *>
        ...
        PROCEDURE DIVISION
            USING LS-COMP-2, LS-BUFFER, LS-BUFLEN, LS-EXPONENT.
        ...
        5000-PROCESS.
            CALL "NC_ECVT_COMP2" USING
                WS-COMP-2, WS-BUFFER-PTR, WS-BUFLEN, WS-EXPONENT.
            EXIT.
        ...
        END PROGRAM COBCURSES-ECVT-COMP-2.
