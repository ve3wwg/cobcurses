        ...
        PROGRAM-ID. TEST001.
      *> 
      *> THIS PROGRAM IS DESIGNED TO READ IN FILE test001.csv AS
      *> A NORMAL EXCELL *>.CSV COMMA DELIMITED FILE. EACH COLUMN
      *> IN THIS TEST IS REGISTERED BY NUMBER.
      *> 
